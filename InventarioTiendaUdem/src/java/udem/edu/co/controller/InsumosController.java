...
import udem.edu.co.facade.InsumosFacade;
...
public class InsumosController implements Serializable {
    ...
    private Insumos current;
    private DataModel items = null;
    @EJB
    private udem.edu.co.facade.InsumosFacade ejbFacade;
    ...
    private InsumosFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Insumos) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InsumosCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InsumosUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InsumosDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
...
>>>>>>> d62c4ae19cdfaff10d5664dd4e7e992b8a37facc
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Insumos) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Insumos.class.getName());
            }
        }
